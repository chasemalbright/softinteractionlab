...
class QuizHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        attr["counter"] = 0
        attr["quiz_score"] = 0
        response = requests.get("https://fa7b-2600-387-a-7-00-4e.ngrok.io/reset")                                         #reset score tunnel
...
class QuizAnswerHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if is_ans_correct:
            ...
            attr["quiz_score"] += 1                                                             ## tunnel in api
            response = requests.get("https://fa7b-2600-387-a-7-00-4e.ngrok.io/increment")
            handler_input.attributes_manager.session_attributes = attr
        else:
            speech = util.get_speechcon(correct_answer=False)
            response = requests.get("https://fa7b-2600-387-a-7-00-4e.ngrok.io/decrement")
